...
A small C program that calculates the successor of a number in modular arithmetic

## 🧩 Description

The source file **succ.c** implements the logic, while **main.o** contains the main entry point.
...
```bash
gcc -I. -std=c99 succ.c -x c main.o -o succ
```
...
The output is successor of `<n>` modulo `<m>`.
...
|:------|:----------------|:-------------|
| `0` `5` | `1` | The initial case considers the successor of `0`, which modulo `5` is `1` |
| `3` `5` | `4` | The middle point case considers the successor of `3`, which modulo `5` is `4` |
| `4` `5` | `0` | The border case considers the successor of `4`, which modulo `5` is `0` |
