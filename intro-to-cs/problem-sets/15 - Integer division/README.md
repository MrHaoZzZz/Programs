...
A small C program that calculates the quotient of two natural numbers.

## 🧩 Description

The source file **division.c** implements the logic, while **main.o** contains the main entry point.
...
```bash
gcc -I. -std=c99 idiv.c -x c main.o -o idiv
```
...
The output is the quotient of `<n>` divided by `<d>`, whenever `<n>` and `<d>` are natural numbers and `<d>` is not 0.
...
|:------|:----------------|:-------------|
| `7` `2`  | `3` |  The quotient of the division of 7 by 2 is 3 (reminder is 1) |
| `10` `5` | `2` | The quotient of the division of 10 by 5 is 2 (reminder is 0)  |
| `0` `4` | `0` |  The quotient of 0 divided by any number is 0|
