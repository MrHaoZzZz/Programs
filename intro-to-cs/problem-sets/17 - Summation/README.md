...
A small C program that calculates the summation from 0 to a possitive number.

## 🧩 Description

The source file **summation.c** implements the logic, while **main.o** contains the main entry point.
...
```bash
gcc -I. -std=c99 summation.c -x c main.o -o summation
```
...
The output is the summation of `<n>`.
